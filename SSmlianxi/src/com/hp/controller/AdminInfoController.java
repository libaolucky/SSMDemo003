...
public class AdminInfoController {
    ...
    @RequestMapping("/a1")
    public Map a1(AdminInfo adminInfo){
    ...
    @RequestMapping("/a4")
    @ResponseBody
    public Map a4(@RequestBody AdminInfo adminInfo){
        System.out.println("adminInfo = " + adminInfo);
        Map codeMap=new HashMap();
        codeMap.put("code",0);
        codeMap.put("msg","请求访问成功！");
    ...
    public ModelAndView demo2(AdminInfo adminInfo){
        ModelAndView modelAndView=new ModelAndView();
        modelAndView.addObject("lname",adminInfo.getLname());
        modelAndView.addObject("pwd",adminInfo.getPwd());
    ...
    public String model(AdminInfo adminInfo, Model model){
        model.addAttribute("lname",adminInfo.getLname());
        model.addAttribute("pwd",adminInfo.getPwd());
        return "home";
    }

    //4: modelAndMap 传值
    @RequestMapping("/demo4")
    public String demo4(AdminInfo adminInfo, ModelMap modelMap){
        modelMap.put("lname",adminInfo.getLname());
        modelMap.put("pwd",adminInfo.getPwd());
        return "home";
    }

    //5: map 传值
    @RequestMapping("/demo5")
    public String demo5(AdminInfo adminInfo,Map<String, Object> map) {
        map.put("lname", adminInfo.getLname());
        map.put("pwd", adminInfo.getPwd());
        return "home";
    }

...
public class CustomerController {
    ...
    @RequestMapping("/a1")
    public Map a1(Customer customer){
    ...
    @RequestMapping("/a4")
    @ResponseBody
    public Map a4(@RequestBody Customer customer){
        System.out.println("customer = " + customer);
        Map codeMap=new HashMap();
        codeMap.put("code",0);
        codeMap.put("msg","请求访问成功！");
        codeMap.put("data",customer);
        return codeMap;
    }
    //5、接收 多个对象
    ...
    public ModelAndView demo2(Customer customer){
        ModelAndView modelAndView=new ModelAndView();
        modelAndView.addObject("lname",customer.getLname());
        modelAndView.addObject("pwd",customer.getPwd());
    ...
    public String demo4(Customer customer, ModelMap modelMap){
        modelMap.put("lname",customer.getLname());
        modelMap.put("pwd",customer.getPwd());
        return "home";
    }

    //5: map 传值
    @RequestMapping("/demo5")
    public String demo5(Customer customer,Map<String, Object> map) {

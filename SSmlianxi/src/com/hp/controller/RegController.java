...
public class RegController {
    ...
    @RequestMapping("/a4")
    @ResponseBody
    public Map a4(@RequestBody Reg reg){
        System.out.println("reg = " + reg);
        Map codeMap=new HashMap();
        codeMap.put("code",0);
        codeMap.put("msg","请求访问成功！");
        codeMap.put("data",reg);
        return codeMap;
    }
    //5、接收 多个对象
    ...
    public ModelAndView demo2(Reg reg){
        ModelAndView modelAndView=new ModelAndView();
        modelAndView.addObject("lname",reg.getLname());
        modelAndView.addObject("pwd",reg.getPwd());
    ...
    public String model(Reg reg, Model model){
        model.addAttribute("lname",reg.getLname());
    ...
    public String demo4(Reg reg, ModelMap modelMap){
        modelMap.put("lname",reg.getLname());
        modelMap.put("pwd",reg.getPwd());
        return "home";
    }

    //5: map 传值
    @RequestMapping("/demo5")
    public String demo5(Reg reg,Map<String, Object> map) {
        map.put("lname", reg.getLname());
        map.put("pwd", reg.getPwd());
        return "home";
    }

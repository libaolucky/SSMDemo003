...
public class HoutaiController {
    ...
    @RequestMapping("/a1")
    public Map a1(Houtai houtai){
        System.out.println("houtai = " + houtai);
    ...
    @RequestMapping("/a4")
    @ResponseBody
    public Map a4(@RequestBody Houtai houtai){
        System.out.println("houtai = " + houtai);
        Map codeMap=new HashMap();
        codeMap.put("code",0);
        codeMap.put("msg","请求访问成功！");
        codeMap.put("data",houtai);
        return codeMap;
    }
    //5、接收 多个对象
    ...
    public ModelAndView demo2(Houtai houtai){
        ModelAndView modelAndView=new ModelAndView();
        modelAndView.addObject("lname",houtai.getLname());
        modelAndView.addObject("pwd",houtai.getPwd());
    ...
    public String model(Houtai houtai, Model model){
        model.addAttribute("lname",houtai.getLname());
        model.addAttribute("pwd",houtai.getPwd());
        return "home";
    }

    //4: modelAndMap 传值
    @RequestMapping("/demo4")
    public String demo4(Houtai houtai, ModelMap modelMap){
        modelMap.put("lname",houtai.getLname());
        modelMap.put("pwd",houtai.getPwd());
        return "home";
    }

    //5: map 传值
    @RequestMapping("/demo5")
    public String demo5(Houtai houtai,Map<String, Object> map) {
        map.put("lname", houtai.getLname());
        map.put("pwd", houtai.getPwd());
        return "home";
    }

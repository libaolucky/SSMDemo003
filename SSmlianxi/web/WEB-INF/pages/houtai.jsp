...
<html>
<head>
    <title>springmvc 之 ajax和mvc收参数 练习3</title>
</head>
<body>
 <div>
    ...
    $(function () {
        ...
        $("#a4").click(function () {
            ...
            $.ajax({
                url:'/Hou/a4',
                type:'POST',
               data:JSON.stringify(houtai),   //变成json对象后，就需要 Content-Type 更改为：
        ...
        $("#a8").click(function () {
            $.ajax({
                ...
                dataType:'json',
                data:{
                    'name':'小米啦',   //4 个k-v 是3个参数，name和age 是对象  和其他两个参数
                    'age':19,
                    'pageSize':5,
                    'page':2
                },

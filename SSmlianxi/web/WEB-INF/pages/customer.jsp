...
<html>
<head>
    <title>springmvc 之 ajax和mvc收参数 练习5</title>
</head>
<body>
 <div>
    ...
    $(function () {
        ...
        $("#a4").click(function () {
            ...
            $.ajax({
                url:'/cust/a4',
                type:'POST',
               data:JSON.stringify(customer),   //变成json对象后，就需要 Content-Type 更改为：
        ...
        $("#a8").click(function () {
            $.ajax({
                ...
                dataType:'json',
                data:{
                    'name':'放样',   //4 个k-v 是3个参数，name和age 是对象  和其他两个参数
                    'age':20,
                    'pageSize':5,
                    'page':2
                },
